-- Canonical DDL (TECHNICAL-DESIGN.md §3.1).
-- Applied verbatim as migration 0001; `transcripts_fts` is created separately at
-- connect time because FTS5 may be absent from the bundled SQLite (§19.1).
